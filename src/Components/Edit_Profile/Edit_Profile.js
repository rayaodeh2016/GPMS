...
function Edit_Profile() {
    ...
    const Personal_Info_Disable = Personal_info.map(Value => {
        return (
            <div className="row mt-3" key={Value.id}>
                <i className={Value.Icon} style={Icon_Style}></i> <div className="col-md-6"><input type="text" className="form-control" placeholder={Value.Name} disabled /></div>
                ...
                <div className="row ">
                    <div className="col-md-6 border-right">
                        <div className="d-flex flex-column align-items-center text-center p-3 py-5">
                            <img class="rounded-circle mt-5" src={X} width="120" alt="" />
                    ...
                    <div className="col-md-6" style={{ textAlign: 'center' }}>
                        <div className="p-3 py-3">
                            <div className="d-flex justify-content-between align-items-center mb-3">
                                <h3 className="text-black-50" style={{ textAlign: 'center' }}>Edit Profile <i className="fas fa-user-edit"></i></h3>
                            </div>
                            ...
                            <div className="row mt-3">
                                <i className="far fa-envelope" style={Icon_Style}></i>
                                <div className="col-md-6"><input type="text" className="form-control" placeholder="Email" /></div>
                            </div>
                            <div className="row mt-3">
                                <div className="col-md-6"><button className="btn btn-primary profile-button" type="button"> Save Edit <i className="fas fa-check fa-lg"></i></button></div>
                            </div>
                        </div>
                    </div>
                </div>
